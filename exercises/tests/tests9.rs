...
extern "Rust" {
    ...
    #[link_name = "my_demo_function"]// This attribute is needed to prevent Rust from mangling the function name.
...
mod foo {
    ...
    #[no_mangle] // This attribute prevents Rust from mangling the function name.
